import caImage from './images/dpk-client-ca-website.png';
import csImage from './images/dpk-client-cs-website.png';
import dtImage from './images/dpk-client-dt-website.png';
import lrImage from './images/dpk-client-lr-website.png';
import tviImage from './images/dpk-client-tvi-website.png';
import udImage from './images/dpk-client-ud-website.png';
...
export const data = [{
  ...
  project: 'Creative Direction + UX Design',
  client: 'Drivetime :: career portal',
  description: 'Wireframing :: Sitemap :: Photoshop skins :: Animation',
  image: dtImage
}, {
  project: 'UX Design + Application Development',
  client: 'Levy Restaurants',
  description: 'Wireframing :: Photoshop skins :: Flash :: As3',
  image: lrImage
}, {
  project: 'Branding + Website',
  client: 'Technologyville',
  description: 'Logo & collateral design, custom wordpress theme :: HTML5, Css3, Jquery, and PHP',
  image: tviImage
}, {
  project: 'Website + Mobile',
  client: 'Ultra Diamonds',
  description: 'HTML5, CSS3, JQUERY, and PHP',
  image: udImage
}, {
  project: 'Branding + Website',
  client: 'Windsor Advantage',
  description: 'Logo & collateral design, custom wordpress theme :: HTML5, Css3, Jquery, and PHP',
  image: waImage
}, {
  project: 'Website + Mobile',
  client: 'Walgreens',
  description: 'Wireframing :: Photoshop Skins',
  image: wagImage
}];
